...
const translations = {
  en: {
    ...
    // CoreSAN
    san_badge: 'Software-Defined Storage',
    san_title: 'CoreSAN — Storage that heals itself',
    san_subtitle: 'A fully distributed, software-defined storage system built in Rust. Aggregate disks across nodes into replicated, self-healing storage pools — no central coordinator required.',

    san_replication: 'Cross-Node Replication',
    san_replication_desc: 'Configurable Failures To Tolerate (FTT 0–2). Data is automatically replicated across nodes with async push replication. Read from any node — data is transparently fetched from peers.',
    san_selfhealing: 'Self-Healing & Auto-Repair',
    san_selfhealing_desc: 'Continuous background repair restores FTT guarantees after node or disk failures. SHA-256 integrity checks detect and fix corruption automatically.',
    san_fuse: 'FUSE Filesystem',
    san_fuse_desc: 'Every volume is mounted as a local directory via FUSE. VMs and applications access distributed storage as regular files — zero API integration required.',
    san_decentralized: 'Fully Decentralized',
    san_decentralized_desc: 'No central metadata server. Peer-to-peer architecture with quorum-based consensus and deterministic leader election. No single point of failure.',

    san_raid: 'Local RAID Policies',
    san_raid_desc: 'Per-volume choice of Stripe (RAID-0), Mirror (RAID-1), or Stripe-Mirror (RAID-10) across local disks.',
    san_quorum: 'Quorum & Leader Election',
    san_quorum_desc: 'Active, Degraded, or Fenced states with witness support for 2-node clusters. Deterministic leader election without voting.',
    san_integrity: 'Integrity Verification',
    san_integrity_desc: 'Automatic SHA-256 checksums on all writes. Hourly full scans detect silent corruption and trigger repair from healthy replicas.',
    san_benchmark: 'Network Benchmarking',
    san_benchmark_desc: 'Built-in all-to-all performance testing. Continuous bandwidth, latency, and jitter monitoring between every node pair.',
    san_rebalancer: 'Automatic Rebalancing',
    san_rebalancer_desc: 'Data automatically evacuated from draining or failing disks. Chunks redistributed evenly across healthy backends.',
    san_hotplug: 'Hot-Add & Hot-Remove',
    san_hotplug_desc: 'Add or remove disks at runtime. CoreSAN detects changes automatically and integrates new capacity without downtime.',

    san_diagram_title: 'CoreSAN Architecture',
    san_disks: 'Disks',
    san_auto_replication: 'Automatic Replication & Peer Sync',
    san_unified_pool: 'Unified Storage Pool',
    san_ftt_policy: 'Policy',
    san_ftt_copies: 'Copies',
    san_ftt_tolerance: 'Fault Tolerance',
    san_ftt_capacity: 'Eff. Capacity',
    san_ftt_none: 'None',
    san_ftt_one_node: '1 Node Failure',
    san_ftt_two_nodes: '2 Node Failures',
  ...
  de: {
    ...
    // CoreSAN
    san_badge: 'Software-Defined Storage',
    san_title: 'CoreSAN — Storage, das sich selbst heilt',
    san_subtitle: 'Ein vollständig verteiltes, softwaredefiniertes Speichersystem in Rust. Aggregiert Disks über Nodes hinweg zu replizierten, selbstheilenden Storage-Pools — ohne zentralen Koordinator.',

    san_replication: 'Cross-Node-Replikation',
    san_replication_desc: 'Konfigurierbare Failures To Tolerate (FTT 0–2). Daten werden automatisch über Nodes hinweg mit asynchroner Push-Replikation verteilt. Von jedem Node lesbar — Daten werden transparent von Peers geholt.',
    san_selfhealing: 'Selbstheilung & Auto-Repair',
    san_selfhealing_desc: 'Kontinuierliche Hintergrund-Reparatur stellt FTT-Garantien nach Node- oder Disk-Ausfällen wieder her. SHA-256-Integritätsprüfungen erkennen und beheben Korruption automatisch.',
    san_fuse: 'FUSE-Dateisystem',
    san_fuse_desc: 'Jedes Volume wird via FUSE als lokales Verzeichnis gemountet. VMs und Anwendungen greifen auf verteilten Speicher wie auf reguläre Dateien zu — keine API-Integration nötig.',
    san_decentralized: 'Vollständig dezentral',
    san_decentralized_desc: 'Kein zentraler Metadaten-Server. Peer-to-Peer-Architektur mit Quorum-basiertem Konsens und deterministischer Leader-Election. Kein Single Point of Failure.',

    san_raid: 'Lokale RAID-Policies',
    san_raid_desc: 'Pro Volume wählbar: Stripe (RAID-0), Mirror (RAID-1) oder Stripe-Mirror (RAID-10) über lokale Disks.',
    san_quorum: 'Quorum & Leader-Election',
    san_quorum_desc: 'Active-, Degraded- oder Fenced-Status mit Witness-Unterstützung für 2-Node-Cluster. Deterministische Leader-Election ohne Abstimmung.',
    san_integrity: 'Integritätsprüfung',
    san_integrity_desc: 'Automatische SHA-256-Checksummen bei allen Schreibvorgängen. Stündliche Vollscans erkennen stille Korruption und lösen Reparatur von gesunden Repliken aus.',
    san_benchmark: 'Netzwerk-Benchmarking',
    san_benchmark_desc: 'Integriertes All-to-All-Performance-Testing. Kontinuierliche Bandbreiten-, Latenz- und Jitter-Überwachung zwischen allen Node-Paaren.',
    san_rebalancer: 'Automatisches Rebalancing',
    san_rebalancer_desc: 'Daten werden automatisch von ablaufenden oder fehlerhaften Disks evakuiert. Chunks werden gleichmässig auf gesunde Backends verteilt.',
    san_hotplug: 'Hot-Add & Hot-Remove',
    san_hotplug_desc: 'Disks zur Laufzeit hinzufügen oder entfernen. CoreSAN erkennt Änderungen automatisch und integriert neue Kapazität ohne Downtime.',

    san_diagram_title: 'CoreSAN-Architektur',
    san_disks: 'Disks',
    san_auto_replication: 'Automatische Replikation & Peer-Sync',
    san_unified_pool: 'Einheitlicher Storage-Pool',
    san_ftt_policy: 'Policy',
    san_ftt_copies: 'Kopien',
    san_ftt_tolerance: 'Fehlertoleranz',
    san_ftt_capacity: 'Eff. Kapazität',
    san_ftt_none: 'Keine',
    san_ftt_one_node: '1 Node-Ausfall',
    san_ftt_two_nodes: '2 Node-Ausfälle',
